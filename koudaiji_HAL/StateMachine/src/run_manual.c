...
void Run_Mode_Manual_Run(void)
{
    ...
    if(num >= 800)
    {
        ...
        Lcd_ShowNum(96, 100, (run_time/1000), SHOW_SIZE_16, BLUE);
        DS1302_ReadTime(&Real_Time);
        Lcd_ShowTime(96, 130, BLUE, &Real_Time);
    }
    //“上”，“下”，“左”，“右”按键微调功能
    ...
    if(Run_Manual.step == 1) //第二步，检测X坐标输入
    {
        if(Matrix_Key_Value != MATRIX_KEY_NONE)
        {
               ...
               Matrix_Key_Value == MATRIX_KEY_8 || Matrix_Key_Value == MATRIX_KEY_9)
            {
                ...
                Lcd_ShowString(32, 40, "     ", SHOW_SIZE_16, LCD_BACKGROUND);
                Lcd_ShowNum(32, 40, Run_Manual.target_x, SHOW_SIZE_16, BLUE);
    ...
    if(Run_Manual.step == 2)  //第三步，检测Y坐标输入
    {
        if(Matrix_Key_Value != MATRIX_KEY_NONE)
        {
               ...
               Matrix_Key_Value == MATRIX_KEY_8 || Matrix_Key_Value == MATRIX_KEY_9)
            {
                ...
                Lcd_ShowString(32, 70, "     ", SHOW_SIZE_16, LCD_BACKGROUND);
                Lcd_ShowNum(32, 70, Run_Manual.target_y, SHOW_SIZE_16, BLUE);
