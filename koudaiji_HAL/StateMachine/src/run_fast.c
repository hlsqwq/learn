...
void Run_Mode_Fast_Run(void)
{
    ...
    if(Run_Fast.first_flag == true) //判断是否是首次检测（首次检测时需要指示屏幕上所有检测到的物体，以后则只需要指示最后一个就可以）
    {
        ...
        if(Run_Fast.step == 3)
        {
            ...
            {
                Lcd_Show_Page_6();
                Lcd_Draw_Circle((uint16_t)(Run_Fast.res_coord[Run_Fast.i].x/4.27f), 240-(uint16_t)(Run_Fast.res_coord[Run_Fast.i].y/3.2f), 5, BLUE);
                ...
                Lcd_Show_Page_7();
                Object_Message_Store(Run_Fast.res_coord[Run_Fast.i].x, Run_Fast.res_coord[Run_Fast.i].y);
                Run_Fast.i++;
                Run_Fast.user_num1 = 0;
            }
    ...
    else
    {
        ...
        if(Run_Fast.step == 2)
        {
            ...
            {
                Lcd_Show_Page_6();
                Lcd_Draw_Circle((uint16_t)(Run_Fast.res_coord[Run_Fast.res_num-Run_Fast.need_point_num+Run_Fast.i].x/4.27f), 240-(uint16_t)(Run_Fast.res_coord[Run_Fast.res_num-Run_Fast.need_point_num+Run_Fast.i].y/3.2f), 5, BLUE);
                Relay_Control(RELAY_OFF);
                ...
                Relay_Control(RELAY_ON);
                Lcd_Show_Page_7();
                Object_Message_Store(Run_Fast.res_coord[Run_Fast.res_num-Run_Fast.need_point_num+Run_Fast.i].x, Run_Fast.res_coord[Run_Fast.res_num-Run_Fast.need_point_num+Run_Fast.i].y);
                Run_Fast.i++;
                Run_Fast.user_num1 = 0;
            }
