...
void Run_Mode_Static_Run(void)
{
    ...
    if(Run_Static.step == 2)  //第三步，根据检测到的物品的数量挨个指向物体 
    {
        ...
        {
            Lcd_Show_Page_6();
            Lcd_Draw_Circle((uint16_t)(Run_Static.res_coord[Run_Static.point_num].x/4.27f), 240-(uint16_t)(Run_Static.res_coord[Run_Static.point_num].y/3.2f), 5, BLUE);
            ...
            Lcd_Show_Page_7();
            Object_Message_Store(Run_Static.res_coord[Run_Static.point_num].x, Run_Static.res_coord[Run_Static.point_num].y);
